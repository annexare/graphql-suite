...
hero:
  tagline: |
    ...
    <div style="display:flex;align-items:center;gap:1rem;margin-top:1.5rem;">
      <img src="/icons/graphql.svg" width="36" height="36" alt="GraphQL" title="GraphQL" />
      <img src="/icons/drizzle.svg" width="36" height="36" alt="Drizzle ORM" title="Drizzle ORM" style="border-radius:4px;" />
      <img src="/icons/typescript.svg" width="36" height="36" alt="TypeScript" title="TypeScript" style="border-radius:4px;" />
      <img src="/icons/react.svg" width="36" height="36" alt="React" title="React" />
    </div>
  actions:
    - text: Get Started
