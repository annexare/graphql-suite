...
:::caution
Higher depth values can produce very large schemas. The default depth is 3, but we recommend starting at 2 for most apps and increasing only if your application needs deeper nesting. See the [Schema Tuning](/guides/schema-tuning/) guide for benchmarks.
:::
