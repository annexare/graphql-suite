...
head:
  - tag: meta
    attrs:
      property: og:image
      content: https://graphql-suite.annexare.com/og/schema.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://graphql-suite.annexare.com/og/schema.png
...
Inspired by [`drizzle-graphql`](https://github.com/drizzle-team/drizzle-graphql), this package is a purpose-built replacement focused on PostgreSQL with deeper relation support, configurable hooks, permission layers, and row-level security.
