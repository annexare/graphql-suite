...
Both majors are supported and both are exercised in CI. Pick whichever your server framework
supports:

- **graphql 16** — the safe default. Works with graphql-yoga 5, Apollo Server 4, and everything else
  in the current ecosystem.
- **graphql 17** — requires **Node 22 or newer**. Adopt it once the rest of your stack accepts it.
